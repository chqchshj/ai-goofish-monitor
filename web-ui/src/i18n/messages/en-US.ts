...
const enUS = {
  ...
  results: {
    ...
    card: {
      ...
      markUnprocessed: 'Undo done',
      markContacted: 'Mark contacted',
      markNotContacted: 'Undo contacted',
    },
    batch: {
      selectCurrentPage: 'Select / deselect current page',
      selectedCount: '{count} selected',
      selectItem: 'Select this item',
      markProcessed: 'Mark done',
      markContacted: 'Mark contacted',
      hide: 'Hide selected',
      restore: 'Unhide selected',
      clearSelection: 'Clear selection',
      exportCurrentFilter: 'Export current filter',
      markProcessedDone: '{count} items marked done',
      markContactedDone: '{count} items marked contacted',
      hideDone: '{count} items hidden',
      restoreDone: '{count} items unhidden',
