const enUSExtra = {
  sellerDetail: {
    title: 'Seller Detail',
    back: 'Back',
    noResultFile: 'Missing result file parameter. Cannot load seller details.',
    itemCount: '{count} items',
    recommended: '{count} recommended',
    lastCrawl: 'Last crawled',
    edit: 'Edit Tracking',
    deleteTracking: 'Remove Tracking',
    statusLabel: 'Tracking Status',
    notesLabel: 'Notes',
    notesPlaceholder: 'Add notes about this seller...',
    tagsLabel: 'Tags',
    tagsPlaceholder: 'Separate tags with commas',
    saveSuccess: 'Tracking info saved.',
    saveFailed: 'Failed to save.',
    deleteSuccess: 'Tracking removed.',
    deleteFailed: 'Failed to remove tracking.',
    deleteDialogTitle: 'Remove Tracking',
    deleteDialogDescription: 'Remove tracking for seller "{seller}"? Item data will not be deleted.',
    itemsTitle: 'Item History ({total} total)',
