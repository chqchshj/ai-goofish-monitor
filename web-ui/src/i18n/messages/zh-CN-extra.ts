const zhCNExtra = {
  sellerDetail: {
    title: '卖家详情',
    back: '返回',
    noResultFile: '缺少结果文件参数，无法加载卖家详情。',
    itemCount: '共 {count} 件商品',
    recommended: '{count} 件推荐',
    lastCrawl: '最近采集',
    edit: '编辑跟进',
    deleteTracking: '移除跟进',
    statusLabel: '跟进状态',
    notesLabel: '备注',
    notesPlaceholder: '记录卖家相关备注...',
    tagsLabel: '标签',
    tagsPlaceholder: '多个标签用逗号分隔',
    saveSuccess: '跟进信息已保存',
    saveFailed: '保存失败',
    deleteSuccess: '跟进记录已移除',
    deleteFailed: '移除失败',
    deleteDialogTitle: '移除跟进',
    deleteDialogDescription: '确认移除对卖家「{seller}」的跟进记录？卖家商品数据不会被删除。',
    itemsTitle: '商品历史（共 {total} 件）',
    itemsLoadFailed: '加载商品列表失败',
    itemRecommended: '推荐',
    prevPage: '上一页',
    nextPage: '下一页',
    noItems: '暂无商品记录',
