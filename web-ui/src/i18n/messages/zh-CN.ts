...
const zhCN = {
  ...
  results: {
    ...
    card: {
      ...
      contacted: '已联系',
      markProcessed: '标记已处理',
      markUnprocessed: '取消已处理',
      markContacted: '标记已联系',
      markNotContacted: '取消已联系',
    },
    batch: {
      selectCurrentPage: '全选/反选当前页',
      ...
      markProcessedDone: '已处理 {count} 个商品',
      markContactedDone: '已联系 {count} 个商品',
      hideDone: '已屏蔽 {count} 个商品',
      restoreDone: '已取消屏蔽 {count} 个商品',
      failed: '批量操作失败',
    },
  },
  logs: {
